...
-- string.lower è string.upper íå ðàáîòàåò ñ ðóññêèìè ñèìâîëàìè
-- ïîýòîìó îòäåëüíàÿ ôóíêöèÿ ñ ïåðåäåëûâàíèåì.
local lu_rus, ul_rus = {}, {}
for i = 192, 223 do
...
-- Áûë íàïèñàí âðó÷íóþ. Â êîäå áåðåòñÿ òîëüêî ïåðâûé öâåò àâòî, âòîðîé èãíîðèðóåòñÿ.
COLORS = {
...
-- Êëàññèôèêàöèè àâòî, êîòîðûå íàçûâàåò äèñïåò÷åð
-- Êëþ÷ - ÈìÿÔàéëàÑÍàçâàíèåìÀâòî.wav
-- Çíà÷åíèå - èäû àâòîìîáèëåé, êîòîðûå ê íèì îòíîñÿòñÿ.
CARS = {
	["2 Door"]={434, 542, 583},
	...
	["Golf Car"]={457},
	["Hearse"]={442},
	["Helicopter"]={417, 425, 447, 465, 469, 487, 488, 497, 501, 548, 563},
	["Hovercraft"]={539},
	["Icecream Van"]={423},
	["Jeep"]={400, 489, 579},
	["Lawn Mower"]={572},
...
-- ðàéîíû, êîòîðûå íå îçâó÷èâàåò äèñïåò÷åð
-- Êëþ÷: íàçâàíèå ðàéîíà, çíà÷åíèå: ðàéîí, íà êîòîðûé çàìåíÿòü.
AREAS_NOT_VOICED = {
...
-- Åñëè â ðàöèè åñòü âîïðîñèòåëüíîå ñëîâî è êîä 1 èëè êîä 0 ñëîâî,
-- ê ïðèìåðó: "Ïî÷åìó áûë îáúÿâëåí code-0?" èëè "Êòî îáúÿâèë êîä 0?",
-- çâóê íå ïðîèãðûâàåòñÿ.
QUESTION_WORDS = {
	"÷òî", "ïî÷åìó", "çà÷åì", "êóäà", "êòî", "êîãäà", "ãäå", "îòêóäà", "÷åé", "êàê"
}
...
-- Äàëåå èäóò ìàññèâû ñ íàçâàíèÿìè àâòîìîáèëåé è ðàéîíîâ.
